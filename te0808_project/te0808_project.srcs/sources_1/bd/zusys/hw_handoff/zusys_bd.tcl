...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_interconnect_mm2s_0, and set properties
  set axis_interconnect_mm2s_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect:2.1 axis_interconnect_mm2s_0 ]
  set_property -dict [ list \
   ...
   CONFIG.NUM_MI {2} \
   CONFIG.NUM_SI {1} \
 ] $axis_interconnect_mm2s_0

  # Create instance: axis_interconnect_s2mm_0, and set properties
  set axis_interconnect_s2mm_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_interconnect:2.1 axis_interconnect_s2mm_0 ]
  set_property -dict [ list \
   CONFIG.ARB_ON_MAX_XFERS {0} \
   CONFIG.ARB_ON_TLAST {1} \
   ...
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {2} \
 ] $axis_interconnect_s2mm_0

  # Create instance: dma_killer_0, and set properties
  set dma_killer_0 [ create_bd_cell -type ip -vlnv user.org:user:top:1.4 dma_killer_0 ]

  # Create instance: dma_killer_1, and set properties
  set dma_killer_1 [ create_bd_cell -type ip -vlnv user.org:user:top:1.4 dma_killer_1 ]

  # Create instance: ila_rx_0, and set properties
  set ila_rx_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_rx_0 ]
  set_property -dict [ list \
  ...
  # Create instance: ila_sg, and set properties
  set ila_sg [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_sg ]
  set_property -dict [ list \
   CONFIG.ALL_PROBE_SAME_MU_CNT {2} \
   CONFIG.C_ADV_TRIGGER {true} \
   CONFIG.C_DATA_DEPTH {16384} \
  ...
  # Create instance: ila_tx_0, and set properties
  set ila_tx_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 ila_tx_0 ]
  set_property -dict [ list \
   CONFIG.C_ADV_TRIGGER {true} \
   CONFIG.C_DATA_DEPTH {16384} \
   CONFIG.C_NUM_OF_PROBES {9} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {100.000} \
  ...
  connect_bd_intf_net -intf_net S00_AXIS_1 [get_bd_intf_pins axis_interconnect_s2mm_0/S00_AXIS] [get_bd_intf_pins dma_killer_0/m00_axis]
  connect_bd_intf_net -intf_net S00_AXIS_2 [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_interconnect_mm2s_0/S00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXIS_2] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins ila_tx_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_SG] [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins ila_sg/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axis_interconnect_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_interconnect_s2mm_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_interconnect_0_M00_AXIS] [get_bd_intf_pins axis_interconnect_s2mm_0/M00_AXIS] [get_bd_intf_pins ila_rx_0/SLOT_0_AXIS]
  connect_bd_intf_net -intf_net axis_interconnect_mm2s_0_M00_AXIS [get_bd_intf_pins axis_interconnect_mm2s_0/M00_AXIS] [get_bd_intf_pins dma_killer_0/s00_axis]
  connect_bd_intf_net -intf_net axis_interconnect_mm2s_0_M01_AXIS [get_bd_intf_pins axis_interconnect_mm2s_0/M01_AXIS] [get_bd_intf_pins dma_killer_1/s00_axis]
  connect_bd_intf_net -intf_net dma_killer_1_m00_axis [get_bd_intf_pins axis_interconnect_s2mm_0/S01_AXIS] [get_bd_intf_pins dma_killer_1/m00_axis]
  connect_bd_intf_net -intf_net ila_0_TRIG_OUT [get_bd_intf_pins ila_rx_0/TRIG_IN] [get_bd_intf_pins ila_sg/TRIG_OUT]
  connect_bd_intf_net -intf_net ila_rx_0_TRIG_OUT [get_bd_intf_pins ila_rx_0/TRIG_OUT] [get_bd_intf_pins ila_tx_0/TRIG_IN]
  connect_bd_intf_net -intf_net ila_tx_0_TRIG_OUT [get_bd_intf_pins ila_sg/TRIG_IN] [get_bd_intf_pins ila_tx_0/TRIG_OUT]
  ...
  connect_bd_net -net ARESETN_1 [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axis_interconnect_mm2s_0/ARESETN] [get_bd_pins axis_interconnect_s2mm_0/ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axis_interconnect_mm2s_0/M00_AXIS_ARESETN] [get_bd_pins axis_interconnect_mm2s_0/M01_AXIS_ARESETN] [get_bd_pins axis_interconnect_mm2s_0/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_s2mm_0/M00_AXIS_ARESETN] [get_bd_pins axis_interconnect_s2mm_0/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_s2mm_0/S01_AXIS_ARESETN] [get_bd_pins dma_killer_0/m00_axis_aresetn] [get_bd_pins dma_killer_0/s00_axis_aresetn] [get_bd_pins dma_killer_1/m00_axis_aresetn] [get_bd_pins dma_killer_1/s00_axis_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk2 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_interconnect_mm2s_0/ACLK] [get_bd_pins axis_interconnect_mm2s_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_mm2s_0/M01_AXIS_ACLK] [get_bd_pins axis_interconnect_mm2s_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_s2mm_0/ACLK] [get_bd_pins axis_interconnect_s2mm_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_s2mm_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_s2mm_0/S01_AXIS_ACLK] [get_bd_pins dma_killer_0/m00_axis_aclk] [get_bd_pins dma_killer_0/s00_axis_aclk] [get_bd_pins dma_killer_1/m00_axis_aclk] [get_bd_pins dma_killer_1/s00_axis_aclk] [get_bd_pins ila_rx_0/clk] [get_bd_pins ila_sg/clk] [get_bd_pins ila_tx_0/clk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk2] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
