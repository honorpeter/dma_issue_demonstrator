/**
 * Most of the functions of this file are taken from the example "multichan_sg_intr" provided by Xilinx,
 * with small changes.
 * Functions sendPacket() and receivePacket() are custom functions.
 *
