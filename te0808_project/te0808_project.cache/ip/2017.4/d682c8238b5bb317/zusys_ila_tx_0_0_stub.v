...
/* synthesis syn_black_box black_box_pad_pin="clk,trig_out,trig_out_ack,trig_in,trig_in_ack,probe0[0:0],probe1[31:0],probe2[3:0],probe3[0:0],probe4[0:0],probe5[0:0],probe6[3:0],probe7[4:0],probe8[4:0]" */;
  input clk;
  output trig_out;
  input trig_out_ack;
  input trig_in;
