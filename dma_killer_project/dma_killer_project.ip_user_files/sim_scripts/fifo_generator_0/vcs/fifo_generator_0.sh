...
#
# Generated by Vivado on Sat Jan 12 14:37:52 CET 2019
...
# Design libraries
design_libs=(fifo_generator_v13_2_1 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../dma_killer_project.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/matt/Git/dma_issue_demonstrator/dma_killer_project/dma_killer_project.cache/compile_simlib/vcs"
  fi
